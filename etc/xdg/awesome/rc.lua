...
beautiful.init("/usr/share/awesome/themes/earth-blue/theme.lua")
...
netaccessmenu = {
	...
	{ "firefox-prx-ch", terminal .. " -e ./.sec/firefox_start.sh" },
	{ "tor", "torbrowser-launcher" }, --" echo ./.sec/tor_start.sh" },
	
}

monitormenu = {
	{ "iftop", terminal .. " -e sh -c './monitor/iftop.sh ; bash'" },

	{ "netstat", terminal .. " -e sh -c 'netstat ; bash'" },
	{ "nload", terminal .. " -e sh -c 'nload -m ; bash'" },
	{ "issniff", terminal .. " -e sh -c './monitor/issniff.sh ; bash'" },
	{ "netsniff", terminal .. " -e sh -c './monitor/netsniff.sh ; bash'" },
	{ "wireshark", "wireshark" },
	{ "bettercap", terminal .. " -e sh -c './monitor/bettercap.sh ; bash'" },
	{ "speedometer", terminal .. " -e sh -c './monitor/speedometer.sh ; bash'" }
}

toolsmenu = {
	{ "airgeddon", terminal .. " -e sh -c './tools/airgeddon.sh ; bash'" },
	{ "tcpdump", terminal .. " -e sh -c './tools/tcpdump.sh ; bash'" },
	{ "batctl", terminal .. " -e sh -c 'batctl -h ; bash'" },
	{ "bittwist", terminal .. " -e sh -c 'bittwist -h ; bash'" },
	{ "cadaver", terminal .. " -e sh -c 'cadaver -h ; bash'" }
}

networkmenu = {
	{ "access", netaccessmenu },
	{ "monitor", monitormenu },
	{ "tools", toolsmenu }
}

systoolsmenu = {
	{ "setterm", terminal .. " -e sh -c 'setterm --help ; bash'" },
	{ "htop", terminal .. " -e sh -c 'htop ; bash'"} 
}

calendarmenu = {
	{ "cal",  terminal .. " -e sh -c 'cal -y 2020 ; bash'" },
	{ "khalc", terminal .. " -e sh -c 'khal --color calendar ; bash'" },
	{ "khal", terminal .. " -e sh -c 'khal ; bash'" }
}

toolsmenu = {
	{ "sound", terminal .. " -e sh -c 'vlc &; bash'" }
}
...
automationmenu = {
  ...
  { "weblogic.zmap", "urxvt -e sh -c 'weblogic.zmap ; bash'" },
  ...
  { "sipvicious_svcrack", "urxvt -e sh -c 'sipvicious_svcrack ; bash'" },
  { "sipvicious_svmap", "urxvt -e sh -c 'sipvicious_svmap ; bash'" },
  { "sipvicious_svreport", "urxvt -e sh -c 'sipvicious_svreport ; bash'" },
  { "sipvicious_svwar", "urxvt -e sh -c 'sipvicious_svwar ; bash'" },
  { "sn00p", "urxvt -e sh -c 'sn00p -h ; bash'" },
...
automobilemenu = {
  ...
  { "jacd", "urxvt -e sh -c 'jacd ; bash'" },
  { "jcat-can-utils", "urxvt -e sh -c 'jcat-can-utils ; bash'" },
  { "jsr", "urxvt -e sh -c 'jsr ; bash'" },
...
binarymenu = {
  ...
  { "detect-it-easy", "urxvt -e sh -c 'detect-it-easy ; bash'" },
  ...
  { ".coverrc", "urxvt -e sh -c '.coverrc ; bash'" },
  { "cover", "urxvt -e sh -c 'cover ; bash'" },
  { "jade", "urxvt -e sh -c 'jade ; bash'" },
  { "jsesc", "urxvt -e sh -c 'jsesc ; bash'" },
  { ".eslintrc", "urxvt -e sh -c '.eslintrc ; bash'" },
  { "_mocha", "urxvt -e sh -c '_mocha ; bash'" },
  { "mocha", "urxvt -e sh -c 'mocha ; bash'" },
  ...
  { "ncp", "urxvt -e sh -c 'ncp ; bash'" },
  { "semver", "urxvt -e sh -c 'semver ; bash'" },
  { "regexp-tree", "urxvt -e sh -c 'regexp-tree ; bash'" },
  { "parser", "urxvt -e sh -c 'parser ; bash'" },
  { "jsesc", "urxvt -e sh -c 'jsesc ; bash'" },
  { "semver", "urxvt -e sh -c 'semver ; bash'" },
  { "uuid", "urxvt -e sh -c 'uuid ; bash'" },
  { "which", "urxvt -e sh -c 'which ; bash'" },
  { "libz3.so", "urxvt -e sh -c 'libz3.so ; bash'" },
  { "jsesc", "urxvt -e sh -c 'jsesc ; bash'" },
  { "parser", "urxvt -e sh -c 'parser ; bash'" },
  { "jsesc", "urxvt -e sh -c 'jsesc ; bash'" },
  { "parser", "urxvt -e sh -c 'parser ; bash'" },
...
debuggermenu = {
  ...
  { "ghidra-debug", "urxvt -e sh -c 'ghidra-debug ; bash'" },
  { "ghidra-headless", "urxvt -e sh -c 'ghidra-headless ; bash'" },
  { "lldb", "urxvt -e sh -c 'lldb ; bash'" },
  { "lldb-argdumper", "urxvt -e sh -c 'lldb-argdumper ; bash'" },
  { "lldb-instr", "urxvt -e sh -c 'lldb-instr ; bash'" },
  { "lldb-mi", "urxvt -e sh -c 'lldb-mi ; bash'" },
  ...
  { "rr_page_32", "urxvt -e sh -c 'rr_page_32 ; bash'" },
  { "rr_page_64", "urxvt -e sh -c 'rr_page_64 ; bash'" },
...
decompilermenu = {
  ...
  { "retdec", "urxvt -e sh -c 'retdec ; bash'" },
...
defensivemenu = {
  ...
  { "argon2", "urxvt -e sh -c 'argon2 -h ; bash'" },
  { "argus", "urxvt -e sh -c 'argus -h ; bash'" },
  ...
  { "exiv2", "urxvt -e sh -c 'exiv2 -h ; bash'" },
  { "fastnetmon", "urxvt -e sh -c 'fastnetmon --help ; bash'" },
  { "fastnetmon_client", "urxvt -e sh -c 'fastnetmon_client ; bash'" },
...
fuzzermenu = {
  ...
  { "responder-smbrelay", "urxvt -e sh -c 'responder-smbrelay ; bash'" },
  { "responder-mr", "urxvt -e sh -c 'responder-mr ; bash'" },
  { "responder-mr-dhcp", "urxvt -e sh -c 'responder-mr-dhcp ; bash'" },
  { "responder-mr-icmp-redirect", "urxvt -e sh -c 'responder-mr-icmp-redirect ; bash'" },
  { "responder-mr-runfinger", "urxvt -e sh -c 'responder-mr-runfinger ; bash'" },
  { "responder-mr-smbrelay", "urxvt -e sh -c 'responder-mr-smbrelay ; bash'" },
...
miscmenu = {
  ...
  { "rabid_setup", "urxvt -e sh -c 'rabid_setup ; bash'" },
  ...
  { "easy_install-2.7", "urxvt -e sh -c 'easy_install-2.7 ; bash'" },
  { "pip", "urxvt -e sh -c 'pip ; bash'" },
  { "pip2", "urxvt -e sh -c 'pip2 ; bash'" },
  { "pip2.7", "urxvt -e sh -c 'pip2.7 ; bash'" },
  { "python", "urxvt -e sh -c 'python ; bash'" },
  { "python2", "urxvt -e sh -c 'python2 ; bash'" },
  { "python2.7", "urxvt -e sh -c 'python2.7 ; bash'" },
  { "web2ldap", "urxvt -e sh -c 'web2ldap ; bash'" },
  { "wheel", "urxvt -e sh -c 'wheel ; bash'" },
...
networkingmenu = {
  ...
  { "tor", "urxvt -e sh -c '~/tor-browser/start-tor-browser.desktop ; bash'" },
...
reconmenu = {
  ...
  { "osr-entify", "urxvt -e sh -c 'osr-entify -h ; bash'" },
  { "osr-enumerate-profiles", "urxvt -e sh -c 'osr-enumerate-profiles ; bash'" },
  ...
  { "chromedriver_linux64", "urxvt -e sh -c 'chromedriver_linux64 ; bash'" },
  { "chromedriver_mac64", "urxvt -e sh -c 'chromedriver_mac64 ; bash'" },
  { "userrecon", "urxvt -e sh -c 'userrecon ; bash'" },
...
scannermenu = {
  ...
  { "nmapfe", "urxvt -e sh -c 'nmapfe ; bash'" },
  { "nping", "urxvt -e sh -c 'nping -h ; bash'" },
  { "xnmap", "urxvt -e sh -c 'xnmap ; bash'" },
  { "zenmap", "urxvt -e sh -c 'zenmap ; bash'" },
  { "ncat", "urxvt -e sh -c 'ncat -h ; bash'" },
  { "ndiff", "urxvt -e sh -c 'ndiff -h ; bash'" },
  { "nmap", "urxvt -e sh -c 'nmap -h ; bash'" },
  { "nmapfe", "urxvt -e sh -c 'nmapfe ; bash'" },
...
wirelessmenu = {
  ...
  { "wlancow2hcxpmk", "urxvt -e sh -c 'wlancow2hcxpmk ; bash'" },
  { "wlanhc2hcx", "urxvt -e sh -c 'wlanhc2hcx -h ; bash'" },
  { "wlanhcx2essid", "urxvt -e sh -c 'wlanhcx2essid -h ; bash'" },
  ...
  { "wlanhcxmnc", "urxvt -e sh -c 'wlanhcxmnc -h ; bash'" },
...
--baticon_image = image({beautiful.widget_battery})
...
--local ramwidget = wibox.widget.ram-widget()
