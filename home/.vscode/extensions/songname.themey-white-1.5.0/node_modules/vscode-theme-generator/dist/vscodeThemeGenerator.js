...
var VscodeThemeGenerator = (function () {
    ...
    VscodeThemeGenerator.prototype._applyWorkbenchColors = function (theme, colorSet) {
        ...
        theme.colors['editor.lineHighlightBorder'] = colorSet.ui.rangeHighlight ? colorSet.ui.rangeHighlight : color_1.addAlpha('#FFFFFF', 0.1);
        ...
        if (colorSet.overrides) {
            var keys = Object.keys(colorSet.overrides);
